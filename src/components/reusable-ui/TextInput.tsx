...
type VersionType = "normal" | "minimalist"
...
const TextInput = React.forwardRef<HTMLInputElement, TextInputProps>( // Spécification explicite du type pour `HTMLInputElement`
